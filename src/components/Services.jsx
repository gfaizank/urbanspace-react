...
const servicesData = [
  {
    ...
    image: 'https://img.freepik.com/premium-photo/air-conditioner-service-indoors-air-conditioner-cleaning-technician-he-opened-front-cover-took-out-filters-washed-it-he-uniform-wearing-rubber-mask_208349-1339.jpg', // Replace with your image path
  },
  {
    title: 'Washing Machine Repair',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    image: 'https://st3.depositphotos.com/16122460/34719/i/450/depositphotos_347191100-stock-photo-professional-plumber-repairing-washing-machine.jpg', // Replace with your image path
  },
  {
    title: 'TV Repair',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    image: 'https://media.istockphoto.com/id/832983526/photo/electrician-checking-television.jpg?s=612x612&w=0&k=20&c=cy0kefsswlabBndRp2-CnbZesSgSpEqclCyp5DBmtjc=', // Replace with your image path
  },
  {
    title: 'Refrigerator Repair',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    image: 'https://st2.depositphotos.com/2249091/5553/i/450/depositphotos_55533327-stock-photo-handyman-during-fridge-repair.jpg', // Replace with your image path
  },
  {
    title: 'Microwave Repair',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    image: 'https://st3.depositphotos.com/1177973/18302/i/450/depositphotos_183024554-stock-photo-young-man-repairing-microwave-oven.jpg', // Replace with your image path
  },
  {
    title: 'Water Purifier Services',
    description: 'Lorem ipsum dolor sit amet, consectetur adipiscing elit.',
    image: 'https://www.vblue.in/images/ro-water-purifier-installation.jpg', // Replace with your image path
  },
];
...
const totalSlidesDesktop = Math.ceil(brandLogos.length / logosPerSlideDesktop);
      ...
      {slideLogos.map((logo, index) => (
        <div key={index} className="w-1/4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src={logo} alt={`Brand ${startIdx + index + 1}`} className="w-full h-32 sm:h-40 object-contain" />
            <div className="p-4">
              <h3 className="text-xl font-semibold">Brand {startIdx + index + 1}</h3>
...
for (let i = 0; i < totalSlidesMobile; i++) {
  ...
  slides.push(
    <div key={i + totalSlidesDesktop} className="flex sm:hidden space-x-4"> {/* Show for mobile screens */}
      {slideLogos.map((logo, index) => (
        <div key={index} className="w-1/3">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <img src={logo} alt={`Brand ${startIdx + index + 1}`} className="w-full h-8 sm:h-40 object-contain" />
            <div className="p-4">
              <h3 className="text-xl font-semibold">Brand {startIdx + index + 1}</h3>
              <p className="text-gray-300">Description</p>
            </div>
...
servicesFetch();
  ...
  style={customStyles}
  contentLabel="Book Your Service"
...
>
  <div className="bg-white p-6 w-96 rounded-lg shadow-md">
    ...
    <form className="space-y-4">
      ...
      <div className="flex flex-col">
        <label htmlFor="appliance-type" className="text-sm font-semibold">
          Appliance Type
        </label>
        <input
          type="text"
      ...
      <div className="flex flex-col">
              <label htmlFor="service-date" className="text-sm font-semibold">
                Service Date
              </label>
              <DatePicker
               id="service-date"
      ...
      <button
        type="submit"
        className="bg-[#00df9a] text-white px-4 py-2 rounded-md hover:bg-[#00df9a] focus:outline-none focus:ring focus:ring-indigo-300"
      >
        Submit
      </button>
    </form>
    ...
    <button
      onClick={closeModal}
      className="mt-4 bg-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-400 focus:outline-none focus:ring focus:ring-gray-300"
    >
      Close
    </button>
  </div>
